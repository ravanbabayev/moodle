...
/**
 * Version details for the Lidio payment system plugin.
 *
 * @package    local_lidio
...
$plugin->version   = 2025052007;       // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release   = '0.2.1';          // Human-readable version name.
